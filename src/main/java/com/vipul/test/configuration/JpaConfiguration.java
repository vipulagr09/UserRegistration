package com.vipul.test.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.vipul.test.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.vipul.test.model" });
